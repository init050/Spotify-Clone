...
# This is the directory where Django's collectstatic will gather all static files.
STATIC_ROOT = BASE_DIR / 'staticfiles'

# This tells Django to look for static files in the frontend's build directory.
STATICFILES_DIRS = [
...
if 'test' in sys.argv:
    ...
    # Use local file storage for tests to avoid connecting to S3
    STORAGES = {
        'default': {
