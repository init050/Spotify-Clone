...
if 'test' in sys.argv:
    ...
    # Use a file-based cache for tests to ensure state persists between requests
    CACHES = {
        'default': {
    ...
    # Disable ratelimit app during tests to avoid system check errors
    ...
    # Make celery tasks synchronous for tests
